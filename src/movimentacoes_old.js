//novo caminho ./Classes/Movimentacoes.js
class Movimentacao {
...
//novo caminho ./Classes/Registro.js
class Registro {
    constructor(dia, mes, ano){
        this.dia = dia,
        this.mes = mes,
        this.ano = ano,
        this.movimentacoes = [] // ou this.movimentacoes = new Movimentacao ~caso esteja 
                                //chamando a classe Movimentacao
    }
